...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/logicaldevices
  TARGETDIR  = lib/Debug
  TARGET     = $(TARGETDIR)/liblogicaldevices.a
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/logicaldevices
...
ifeq ($(config),profiling)
  OBJDIR     = obj/Profiling/logicaldevices
...
ifeq ($(config),debug_rpi)
  ...
  OBJDIR     = obj/rpi/Debug/logicaldevices
  TARGETDIR  = lib/Debug
  TARGET     = $(TARGETDIR)/liblogicaldevices.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DDEBUG
  INCLUDES  += -IARM\ headers
...
ifeq ($(config),release_rpi)
  CC         = arm-linux-gnueabihf-gcc
  CXX        = arm-linux-gnueabihf-g++
  OBJDIR     = obj/rpi/Release/logicaldevices
  TARGETDIR  = lib/Release
  TARGET     = $(TARGETDIR)/liblogicaldevices.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DNDEBUG
  INCLUDES  += -IARM\ headers
...
ifeq ($(config),profiling_rpi)
  CC         = arm-linux-gnueabihf-gcc
  CXX        = arm-linux-gnueabihf-g++
  OBJDIR     = obj/rpi/Profiling/logicaldevices
  TARGETDIR  = lib/Profiling
  TARGET     = $(TARGETDIR)/liblogicaldevices.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DNDEBUG
  INCLUDES  += -IARM\ headers
...
$(OBJDIR)/LogicalDevice.o: Libraries/LogicalDevices/LogicalDevice.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/LogicalDevices.o: Libraries/LogicalDevices/LogicalDevices.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Central.o: Libraries/LogicalDevices/Central.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
