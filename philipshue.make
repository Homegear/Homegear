...
ifeq ($(config),debug)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -LARM\ libraries -Llib/Debug -shared -Wl,-rpath=/lib/homegear -Wl,-rpath=/usr/lib/homegear -l base
...
ifeq ($(config),release)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -LARM\ libraries -Llib/Release -s -shared -Wl,-rpath=/lib/homegear -Wl,-rpath=/usr/lib/homegear -l base
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
...
ifeq ($(config),profiling)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -LARM\ libraries -Llib/Profiling -shared -Wl,-rpath=/lib/homegear -Wl,-rpath=/usr/lib/homegear -l base -pg
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
