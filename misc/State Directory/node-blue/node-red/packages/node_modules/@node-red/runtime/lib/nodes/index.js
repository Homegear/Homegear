...
var log;
var homegear; //Added by Homegear GmbH
...
function createNode(node,def) {
    ...
    node.homegear = homegear.get(); //Added by Homegear GmbH
...
function init(runtime) {
    ...
    log = runtime.log;
    homegear = runtime.homegear; //Added by Homegear GmbH
    credentials.init(runtime);
    flows.init(runtime);
    registry.init(runtime);
    //context.init(runtime.settings); //Removed by Homegear GmbH
    context.init(runtime); //Added by Homegear GmbH
}
