...
var homegearctx = require("./homegearctx"); //Added by Homegear GmbH
...
function init(_runtime) {
    ...
    //stores["_"] = new memory(); //Removed by Homegear GmbH
    //defaultStore = "memory"; //Removed by Homegear GmbH
    stores["_"] = new homegearctx(null, _runtime.homegear.get()); //Added by Homegear GmbH - set Homegear as default context store
    defaultStore = "homegearctx"; //Added by Homegear GmbH
}
    ...
    return new Promise(function(resolve,reject) {
        ...
        if (plugins && Object.keys(plugins).length > 0) {
            ...
            if (hasDefault) {
                ...
                //storeList = ["memory"]; //Removed by Homegear GmbH
                //defaultStore = "memory";
                storeList = ["homegearctx"]; //Added by Homegear GmbH
                defaultStore = "homegearctx"; //Added by Homegear GmbH
            }
            ...
            log.info(log._("context.log-store-init", {name:"default", info:"module=homegearctx"}));
