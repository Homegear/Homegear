...
var api = module.exports = {
    ...
    load: function (credentials) {
        ...
        if (encryptionKeyType === 'system') {
            //log.warn(log._("nodes.credentials.system-key-warning")); //Disabled by Homegear GmbH as not relevant when Homegear is used.
        }
     ...
     */
    get: function (id) {
        //{{{ Modified by Homegear GmbH to get credentials from Homegear
        if (credentialCache.hasOwnProperty(id)) return credentialCache[id];
        try {
            runtime.homegear.get().invoke("getNoderedCredentials", [id]);
        } catch (e) {
            console.log(e);
        }
        //}}}
    ...
    register: function (type, definition) {
        runtime.homegear.get().invoke("setNoderedCredentialTypes", [type, definition]);
