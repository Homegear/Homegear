        ...
        .then(function() {
            ...
            return redNodes.load().then(function() {
                ...
                return redNodes.loadContextsPlugin().then(function () {
                    redNodes.loadFlows().then(redNodes.startFlows).then(runtime.homegear.isReady).catch(function(err) {}); //Added by Homegear GmbH. Added "isReady" to notify Homegear when Node-RED is started.
                    started = true;
                });
            });
        });
