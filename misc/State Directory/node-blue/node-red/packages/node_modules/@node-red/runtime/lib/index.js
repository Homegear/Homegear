...
var homegear = require("./homegear"); //Added by Homegear GmbH
...
function init(userSettings,httpServer,_adminApi,__util) {
    ...
    homegear.init(runtime); //Added by Homegear GmbH
    runtime.homegear = homegear.create(); //Added by Homegear GmbH
...
function start() {
    return i18n.registerMessageCatalog("runtime",path.resolve(path.join(__dirname,"..","locales")),"runtime.json")
        ...
        .then(function() {
            ...
            if (settings.version) {
                log.info(log._("runtime.version",{component:"Node-PINK",version:"v"+settings.version}));
            }
            log.info(log._("runtime.version",{component:"nodejs-homegear ",version:process.version}));
            ...
            return redNodes.load().then(function() {
                ...
                return redNodes.loadContextsPlugin().then(function () {
                    redNodes.loadFlows().then(redNodes.startFlows).then(function() {runtime.homegear.isReady(true);}).catch(function(err) {}); //Added by Homegear GmbH. Added "isReady" to notify Homegear when Node-RED is started.
                    started = true;
                });
            });
        });
...
module.exports = {
    ...
    */
    ...
    storage: storage,
    events: events,
    homegear: homegear, //Added by Homegear GmbH
    hooks: hooks,
    util: require("@node-red/util").util,
