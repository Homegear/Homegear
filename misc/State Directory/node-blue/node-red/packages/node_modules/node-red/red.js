...
if (parsedArgs.help) {
    console.log("Node-PINK v"+RED.version());
    console.log("Usage: node-pink [-v] [-?] [--settings settings.js] [--userDir DIR]");
    console.log("                [--port PORT] [--title TITLE] [--safe] [flows.json]");
    console.log("       node-pink admin <command> [args] [-?] [--userDir DIR] [--json]");
    console.log("");
    console.log("Options:");
...
httpsPromise.then(function(startupHttps) {
    ...
    try {
        ...
        if (err.code == "unsupported_version") {
            ...
            console.log("Node-PINK requires Node.js v8.9.0 or later");
        } else {
    ...
    process.on('SIGUSR1', function() { RED.runtime._.homegear.isReady(false); RED.runtime._.flows.loadFlows(true).then(function() {RED.runtime._.homegear.isReady(true);}); }); //Added by Homegear GmbH
