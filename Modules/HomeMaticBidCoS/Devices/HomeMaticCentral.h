...
public:
	...
	virtual std::shared_ptr<BaseLib::RPC::Variable> activateLinkParamset(std::string serialNumber, int32_t channel, std::string remoteSerialNumber, int32_t remoteChannel, bool longPress);
	virtual std::shared_ptr<BaseLib::RPC::Variable> activateLinkParamset(uint64_t peerID, int32_t channel, uint64_t remoteID, int32_t remoteChannel, bool longPress);
	...
	virtual std::shared_ptr<BaseLib::RPC::Variable> listTeams();
	...
	virtual std::shared_ptr<BaseLib::RPC::Variable> setTeam(std::string serialNumber, int32_t channel, std::string teamSerialNumber, int32_t teamChannel, bool force = false, bool burst = true);
	virtual std::shared_ptr<BaseLib::RPC::Variable> setTeam(uint64_t peerID, int32_t channel, uint64_t teamID, int32_t teamChannel, bool force = false, bool burst = true);
