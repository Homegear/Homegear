...
//RPC Methods
std::shared_ptr<BaseLib::RPC::Variable> MAXPeer::getDeviceInfo(int32_t clientID, std::map<std::string, bool> fields)
{
	try
	{
...
std::shared_ptr<BaseLib::RPC::Variable> MAXPeer::getParamsetDescription(int32_t clientID, int32_t channel, BaseLib::RPC::ParameterSet::Type::Enum type, uint64_t remoteID, int32_t remoteChannel)
{
	try
	{
...
std::shared_ptr<BaseLib::RPC::Variable> MAXPeer::putParamset(int32_t clientID, int32_t channel, BaseLib::RPC::ParameterSet::Type::Enum type, uint64_t remoteID, int32_t remoteChannel, std::shared_ptr<BaseLib::RPC::Variable> variables, bool onlyPushing)
{
	try
	{
		if(_disposing) return BaseLib::RPC::Variable::createError(-32500, "Peer is disposing.");
...
std::shared_ptr<BaseLib::RPC::Variable> MAXPeer::getParamset(int32_t clientID, int32_t channel, BaseLib::RPC::ParameterSet::Type::Enum type, uint64_t remoteID, int32_t remoteChannel)
{
	try
	{
		if(_disposing) return BaseLib::RPC::Variable::createError(-32500, "Peer is disposing.");
...
std::shared_ptr<BaseLib::RPC::Variable> MAXPeer::setInterface(int32_t clientID, std::string interfaceID)
{
	try
	{
...
std::shared_ptr<BaseLib::RPC::Variable> MAXPeer::setValue(int32_t clientID, uint32_t channel, std::string valueKey, std::shared_ptr<BaseLib::RPC::Variable> value)
{
	try
	{
