...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/physicaldevices
  TARGETDIR  = lib/Debug
  TARGET     = $(TARGETDIR)/libphysicaldevices.a
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/physicaldevices
...
ifeq ($(config),profiling)
  OBJDIR     = obj/Profiling/physicaldevices
...
ifeq ($(config),debug_rpi)
  ...
  OBJDIR     = obj/rpi/Debug/physicaldevices
  TARGETDIR  = lib/Debug
  TARGET     = $(TARGETDIR)/libphysicaldevices.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DDEBUG
  INCLUDES  += -IARM\ headers
...
ifeq ($(config),release_rpi)
  CC         = arm-linux-gnueabihf-gcc
  CXX        = arm-linux-gnueabihf-g++
  OBJDIR     = obj/rpi/Release/physicaldevices
  TARGETDIR  = lib/Release
  TARGET     = $(TARGETDIR)/libphysicaldevices.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DNDEBUG
  INCLUDES  += -IARM\ headers
...
ifeq ($(config),profiling_rpi)
  CC         = arm-linux-gnueabihf-gcc
  CXX        = arm-linux-gnueabihf-g++
  OBJDIR     = obj/rpi/Profiling/physicaldevices
  TARGETDIR  = lib/Profiling
  TARGET     = $(TARGETDIR)/libphysicaldevices.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DNDEBUG
  INCLUDES  += -IARM\ headers
