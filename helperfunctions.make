...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/helperfunctions
  TARGETDIR  = lib/Debug
  TARGET     = $(TARGETDIR)/libhelperfunctions.a
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/helperfunctions
...
ifeq ($(config),profiling)
  OBJDIR     = obj/Profiling/helperfunctions
...
ifeq ($(config),debug_rpi)
  ...
  OBJDIR     = obj/rpi/Debug/helperfunctions
  TARGETDIR  = lib/Debug
  TARGET     = $(TARGETDIR)/libhelperfunctions.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DDEBUG
  INCLUDES  += -IARM\ headers
...
ifeq ($(config),release_rpi)
  CC         = arm-linux-gnueabihf-gcc
  CXX        = arm-linux-gnueabihf-g++
  OBJDIR     = obj/rpi/Release/helperfunctions
  TARGETDIR  = lib/Release
  TARGET     = $(TARGETDIR)/libhelperfunctions.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DNDEBUG
  INCLUDES  += -IARM\ headers
...
ifeq ($(config),profiling_rpi)
  CC         = arm-linux-gnueabihf-gcc
  CXX        = arm-linux-gnueabihf-g++
  OBJDIR     = obj/rpi/Profiling/helperfunctions
  TARGETDIR  = lib/Profiling
  TARGET     = $(TARGETDIR)/libhelperfunctions.a
  DEFINES   += -DFORTIFY_SOURCE=2 -DNDEBUG
  INCLUDES  += -IARM\ headers
...
$(OBJDIR)/HelperFunctions.o: Libraries/HelperFunctions/HelperFunctions.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
