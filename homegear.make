...
ifeq ($(config),release)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -Llib/Release -s -Wl,-rpath=/lib/homegear -Wl,-rpath=/usr/lib/homegear -l rpc -l dl -l pthread -l readline -l gcrypt -l gnutls -l user -l cli -l events -l gd -l upnp -l mqtt -l database -l scriptengine -l base -l gpg-error -l sqlite3 -l paho.mqtt.c -l php5
...
ifeq ($(config),debug)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -Llib/Debug -Wl,-rpath=/lib/homegear -Wl,-rpath=/usr/lib/homegear -l rpc -l dl -l pthread -l readline -l gcrypt -l gnutls -l user -l cli -l events -l gd -l upnp -l mqtt -l database -l scriptengine -l base -l gpg-error -l sqlite3 -l paho.mqtt.c -l php5
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
...
ifeq ($(config),profiling)
  ...
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -Llib/Profiling -Wl,-rpath=/lib/homegear -Wl,-rpath=/usr/lib/homegear -l rpc -l dl -l pthread -l readline -l gcrypt -l gnutls -l user -l cli -l events -l gd -l upnp -l mqtt -l database -l scriptengine -l base -l gpg-error -l sqlite3 -l paho.mqtt.c -l php5 -pg
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
