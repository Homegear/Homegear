...
SharedObjectFamilyModules::SharedObjectFamilyModules()
{
}
...
void SharedObjectFamilyModules::onAddWebserverEventHandler(BaseLib::Rpc::IWebserverEventSink* eventHandler, std::map<int32_t, BaseLib::PEventHandler>& eventHandlers)
{
...
void SharedObjectFamilyModules::onRemoveWebserverEventHandler(std::map<int32_t, BaseLib::PEventHandler>& eventHandlers)
{
    for(auto& server : GD::rpcServers)
    {
...
void SharedObjectFamilyModules::onRPCEvent(std::string source, uint64_t id, int32_t channel, std::string deviceAddress, std::shared_ptr<std::vector<std::string>> valueKeys, std::shared_ptr<std::vector<BaseLib::PVariable>> values)
{
    try
    {
...
void SharedObjectFamilyModules::onRPCUpdateDevice(uint64_t id, int32_t channel, std::string address, int32_t hint)
{
    try
    {
...
void SharedObjectFamilyModules::onRPCNewDevices(std::vector<uint64_t>& ids, BaseLib::PVariable deviceDescriptions)
{
    try
    {
...
void SharedObjectFamilyModules::onRPCDeleteDevices(std::vector<uint64_t>& ids, BaseLib::PVariable deviceAddresses, BaseLib::PVariable deviceInfo)
{
    try
    {
...
void SharedObjectFamilyModules::onEvent(std::string source, uint64_t peerID, int32_t channel, std::shared_ptr<std::vector<std::string>> variables, std::shared_ptr<std::vector<BaseLib::PVariable>> values)
{
    try
    {
...
void SharedObjectFamilyModules::onRunScript(BaseLib::ScriptEngine::PScriptInfo& scriptInfo, bool wait)
{
    try
    {
#ifndef NO_SCRIPTENGINE
...
BaseLib::PVariable SharedObjectFamilyModules::onInvokeRpc(std::string& methodName, BaseLib::PArray& parameters)
{
    try
    {
...
int32_t SharedObjectFamilyModules::onCheckLicense(int32_t moduleId, int32_t familyId, int32_t deviceId, const std::string& licenseKey)
{
    try
    {
...
uint64_t SharedObjectFamilyModules::onGetRoomIdByName(std::string& name)
{
    try
    {
...
void SharedObjectFamilyModules::onDecryptDeviceDescription(int32_t moduleId, const std::vector<char>& input, std::vector<char>& output)
{
    try
    {
        auto licensingModulesIterator = GD::licensingModules.find(moduleId);
...
void SharedObjectFamilyModules::homegearStarted()
{
    try
    {
...
void SharedObjectFamilyModules::homegearShuttingDown()
{
    try
    {
...
void SharedObjectFamilyModules::getModuleInfo(std::vector<std::shared_ptr<FamilyModuleInfo>>& moduleInfoVector)
{
    try
    {
...
int32_t SharedObjectFamilyModules::loadModule(const std::string& filename)
{
...
int32_t SharedObjectFamilyModules::unloadModule(const std::string& filename)
{
    _moduleLoadersMutex.lock();
    try
    {
...
int32_t SharedObjectFamilyModules::reloadModule(const std::string& filename)
{
    try
    {
...
void SharedObjectFamilyModules::init()
{
    try
    {
...
void SharedObjectFamilyModules::loadModules()
{
    _moduleLoadersMutex.lock();
    try
    {
...
void SharedObjectFamilyModules::load()
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
void SharedObjectFamilyModules::disposeDeviceFamilies()
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
void SharedObjectFamilyModules::dispose()
{
    try
    {
        _familiesMutex.lock();
...
bool SharedObjectFamilyModules::lifetick()
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
void SharedObjectFamilyModules::save(bool full)
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
bool SharedObjectFamilyModules::peerExists(uint64_t peerId)
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
uint32_t SharedObjectFamilyModules::physicalInterfaceCount(int32_t family)
{
    uint32_t size = 0;
    try
    {
...
bool SharedObjectFamilyModules::physicalInterfaceIsOpen()
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
void SharedObjectFamilyModules::physicalInterfaceStartListening()
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
void SharedObjectFamilyModules::physicalInterfaceStopListening()
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
void SharedObjectFamilyModules::physicalInterfaceSetup(int32_t userID, int32_t groupID, bool setPermissions)
{
    try
    {
        std::map<int32_t, std::shared_ptr<BaseLib::Systems::DeviceFamily>> families = getFamilies();
...
void SharedObjectFamilyModules::listInterfaces(const BaseLib::PArray& array, int32_t familyId)
{
    try
    {
        if(familyId != -1)
