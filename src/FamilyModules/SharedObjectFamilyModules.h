...
class SharedObjectFamilyModules : public BaseLib::Systems::IFamilyEventSink
{
public:
    ...
    SharedObjectFamilyModules();

    ~SharedObjectFamilyModules() override;
     ...
     */
    void getModuleInfo(std::vector<std::shared_ptr<FamilyModuleInfo>>& moduleInfoVector);
...
private:
    ...
    SharedObjectFamilyModules& operator=(const SharedObjectFamilyModules&);
};
